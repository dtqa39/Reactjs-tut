...
2. Điều hướng
	...
	#2. Trong thư mục src, tạo thư mục component, các component chính của trang web (trang web mà ta đang xây dựng) sẽ được lưu trữ tại đây. Trong thư mục src, tạo thư mục CSS, chuyển các file app.css và index.css vào thư mục này, đây là nơi lưu trữ css của trang web
